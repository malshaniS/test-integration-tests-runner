...
DATASOURCE_PATHS = {"product-apim": {"CORE": ["repository/conf/datasources/master-datasources.xml",
                                              "repository/conf/datasources/metrics-datasources.xml"]},
                    "product-is": {"CORE": ["repository/conf/datasources/master-datasources.xml",
                    			            "repository/conf/datasources/metrics-datasources.xml",
...
M2_PATH = {"product-apim": "am/wso2am",
           "product-is": "is/wso2is",
           "product-ei": "ei/wso2ei"
           }
DIST_POM_PATH = {"product-apim": "modules/distribution/product/pom.xml",
                 "product-is": "modules/distribution/pom.xml",
                 "product-ei": "distribution/pom.xml"
                 }
LIB_PATH = {"product-apim": "repository/components/lib",
            "product-is": "repository/components/lib",
            "product-ei": "lib"
            }
...
ARTIFACT_REPORTS_PATHS = {"product-apim": {"apim_tests": ["modules/integration/tests-integration/tests-backend/target/surefire-reports",
                                           "modules/integration/tests-integration/tests-backend/target/logs/automation.log"]
                                           },
                  "product-is": {"is_tests": ["modules/integration/tests-integration/tests-backend/target/surefire-reports",
                                              "modules/integration/tests-integration/tests-backend/target/logs/automation.log"]
                                 },
                  "product-ei": {"mediation-tests-service": ["integration/mediation-tests/tests-service/target/surefire-reports",
                                 ...
                                 "business-process-patches-bpel": ["integration/business-process-tests/tests-patches/bpel/target/surefire-reports",
                                                                   "integration/business-process-tests/tests-patches/bpel/target/logs/automation.log"]
                               }
                  }
IGNORE_DIR_TYPES = {"product-apim": ["junitreports"],
                     "product-is": ["Identity-suite-initializer","junitreports"],
...
TESTNG_XML_PATH = {"product-apim": "modules/integration/tests-integration/tests-backend/src/test/resources/testng.xml",
                   "product-is": "",
                   "product-ei": "integration/business-process-tests/tests-integration/bpel/src/test/resources/testng.xml"
                  }
TESTNG_SERVER_MGT_PATH = {"product-apim": "modules/integration/tests-integration/tests-backend/src/test/resources/testng-server-mgt.xml",
                          "product-is": "",
                          "product-ei": "integration/business-process-tests/tests-integration/bpel/src/test/resources/testng-server-mgt.xml"
                         }
DB_META_DATA = {
    "MYSQL": {"prefix": "jdbc:mysql://", "driverClassName": "com.mysql.jdbc.Driver", "jarName": "mysql.jar",
              "DB_SETUP": {
                  "product-apim": {"WSO2_CARBON_DB_CORE": ['dbscripts/mysql5.7.sql'],
                                   "WSO2AM_DB_CORE": ['dbscripts/apimgt/mysql5.7.sql'],
                                   "WSO2AM_STATS_DB_CORE": [],
                                   "WSO2_MB_STORE_DB_CORE": ['dbscripts/mb-store/mysql-mb.sql'],
                                   "WSO2_METRICS_DB_CORE": ['dbscripts/metrics/mysql.sql']
                                  },
                  "product-is": {"WSO2_CARBON_DB_CORE": ['dbscripts/mysql5.7.sql'],
                                 "WSO2_STATS_DB_CORE": [],
                                 "BPS_DS_CORE": ['dbscripts/bps/bpel/create/mysql.sql'],
                                 "WSO2_METRICS_DB_CORE": ['dbscripts/metrics/mysql.sql']
                                 },
    ...
    "SQLSERVER-SE": {"prefix": "jdbc:sqlserver://",
                     ...
                     "DB_SETUP": {
                         "product-apim": {"WSO2_CARBON_DB_CORE": ['dbscripts/mssql.sql'],
                                          "WSO2AM_DB_CORE": ['dbscripts/apimgt/mssql.sql'],
                                          "WSO2AM_STATS_DB_CORE": [],
                                          "WSO2_MB_STORE_DB_CORE": ['dbscripts/mb-store/mssql-mb.sql'],
                                          "WSO2_METRICS_DB_CORE": ['dbscripts/metrics/mssql.sql']
                         },
                         "product-is": {"WSO2_CARBON_DB_CORE": ['dbscripts/mssql.sql'],
                                        "WSO2_STATS_DB_CORE": ['dbscripts/bps/bpel/create/mssql.sql'],
                                        "BPS_DS_CORE": [],
                                        "WSO2_METRICS_DB_CORE": ['dbscripts/metrics/mssql.sql']
                                        },
    ...
    "ORACLE-SE2": {"prefix": "jdbc:oracle:thin:@", "driverClassName": "oracle.jdbc.OracleDriver",
                   ...
                   "DB_SETUP": {
                       "product-apim": {"WSO2_CARBON_DB_CORE": ['dbscripts/oracle.sql'],
                                        "WSO2AM_DB_CORE": ['dbscripts/apimgt/oracle.sql'],
                                        "WSO2AM_STATS_DB_CORE": [],
                                        "WSO2_MB_STORE_DB_CORE": ['dbscripts/mb-store/oracle-mb.sql'],
                                        "WSO2_METRICS_DB_CORE": ['dbscripts/metrics/oracle.sql']
                                        },
                       "product-is": {"WSO2_CARBON_DB_CORE": ['dbscripts/oracle.sql'],
                                      "WSO2_STATS_DB_CORE": [],
                                      "BPS_DS_CORE": ['dbscripts/bps/bpel/create/oracle.sql'],
                                      "WSO2_METRICS_DB_CORE": ['dbscripts/metrics/oracle.sql']
                                      },
